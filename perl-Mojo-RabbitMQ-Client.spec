...
cp %{_builddir}/Mojo-RabbitMQ-Client-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Mojo-RabbitMQ-Client/e1f58d39e305bc7f8669fd993c6f74a73b4e0542 || :
if test -f Makefile.PL; then
